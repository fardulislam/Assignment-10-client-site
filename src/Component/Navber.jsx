...
rounded-box z-[50] mt-3 w-52 p-2 shadow-xl"
          ...
          <div className="w-10 h-10 bg-blue-600 text-white flex items-center justify-center rounded-xl font-bold text-xl mx-2">
            RC
          </div>
          <a className="text-2xl font-bold">Rent car</a>
        </div>
        ...
        <div className="navbar-end">
          {user ? (
            ...
            <Link
              to={"/login"}
              className="border-1 bg-gradient-to-r from-[#F63049] to-[#D02752]   px-6 py-2 rounded-xl text-white"
            >
              Sign in
            </Link>
          )}
